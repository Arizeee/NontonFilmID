...
<main class="relative z-10 w-full max-w-md">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-muted text-sm" style="animation: cardEntrance 0.6s ease 0.3s both;">Pesan tiket, pilih kursi,
            nikmati film</p>
    </div>
        ...
        <div class="p-7 sm:p-8">
            ...
            <form class="form-panel active mt-6" id="loginForm" novalidate onsubmit="handleLogin(event)">
                ...
                <div class="space-y-5">
                    ...
                    <!-- Submit -->
                    <button type="submit"
                            class="btn-primary w-full py-3.5 rounded-xl text-sm flex items-center justify-center gap-2"
                            id="loginBtn">
            ...
            <form class="form-panel mt-6" id="registerForm" novalidate onsubmit="handleRegister(event)">
                ...
                <div class="space-y-5">
                    ...
                    <label class="flex items-start gap-2.5 cursor-pointer text-sm text-muted hover:text-fg transition-colors">
                        ...
                        <span>Saya setuju dengan <a href="#" class="link-accent" onclick="event.preventDefault()">Syarat & Ketentuan</a> serta <a
                                    href="#" class="link-accent" onclick="event.preventDefault()">Kebijakan Privasi</a></span>
                    </label>
